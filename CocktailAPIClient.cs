...
namespace APIVerve
{
    public class CocktailAPIClient
    {
        ...
        public CocktailAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public CocktailAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, cocktailQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(cocktailQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(cocktailQueryOptions options)
        {
